...
namespace SafeExamBrowser.Configuration.ConfigurationData
{
	internal class DataProcessor
	{
		...
		{
			settings.Proctoring.Enabled = settings.Proctoring.LiveStream.Enabled || settings.Proctoring.JitsiMeet.Enabled || settings.Proctoring.Zoom.Enabled;

			if (settings.Proctoring.LiveStream.Enabled)
			{
				if (!settings.Proctoring.LiveStream.ReceiveVideo)
				{
